...
// the canonical prompt (pipeline/prompts/revisor-editorial-draft.md v1.1.1),
...
const preamble = 'Você é o revisor editorial da Bereia Version (BV), etapa de revisão do tier DRAFT (ER-0019, PIPELINE.md v1.2.0). Sua mudança é somente de FORMA — nunca de sentido.\n' +
  'LEIA, nesta ordem: ' + REPO + '/pipeline/prompts/revisor-editorial-draft.md (v1.1.1, seu papel e regras duras de saída); ' + REPO + '/pipeline/rules/EDITORIAL.md (v1.1.0, autoridade de forma); ' + REPO + '/decisions/DECISOES.md (ER-0011..ER-0019, vinculantes); ' + REPO + '/lexicon/lexicon.json (só se precisar de consistência terminológica).\n' +
